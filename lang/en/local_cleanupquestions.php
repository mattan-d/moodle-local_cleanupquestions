...
$string['nightlycleanuptaskname'] = 'Nightly cleanup of all courses (question bank)';
$string['nightlycleanuptimelimit'] = 'Nightly cleanup: max execution time';
$string['nightlycleanuptimelimit_help'] = 'Maximum time (in seconds/minutes/hours) for each nightly run. When the limit is reached, the task stops and sends the report. Set to "Not limited" to process all courses in one run (not recommended on large sites).';
$string['nightlycleanupmaxcourses'] = 'Nightly cleanup: max courses per run';
$string['nightlycleanupmaxcourses_help'] = 'Maximum number of courses to process in one nightly run. 0 = no limit (only the time limit applies). Use this to spread cleanup over several nights on large sites.';
$string['nightlycleanupreporttitle'] = 'Nightly question cleanup – statistics report';
$string['nightlycleanupreportcourses'] = 'Courses processed: {$a}';
...
$string['nightlycleanupreportunusedquestions'] = 'Unused questions: {$a->deleted} deleted, {$a->skipped} skipped';
$string['nightlycleanupreporttotal'] = 'Total: {$a->deleted} items deleted, {$a->skipped} items skipped';
$string['nightlycleanupreportsubject'] = 'Nightly question cleanup – statistics report';
$string['nightlycleanupreportsmall'] = 'Nightly question cleanup finished. See full report in the notification.';
$string['messageprovider:nightlycleanupreport'] = 'Nightly question cleanup statistics report';
